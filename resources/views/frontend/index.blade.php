...
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><i class="fa fa-home"></i> 測試其他角色Level</div>

                <div class="panel-body">
                    @if (access()->hasRoles(1))
                        這是Administrator權限877
                    @endif
                    @if (access()->hasRoles(2))
                        這是Execute權限877
                    @endif
                    @if (access()->hasRoles(3))
                        這是User權限877
                    @endif
                    @if (access()->hasRoles(4))
                        這是Vip權限877
                    @endif
                </div>
            </div><!-- panel -->
